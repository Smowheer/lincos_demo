...
void GrahsLTC::render_light_forward(unsigned int light_idx) {
...
void GrahsLTC::render_ltc_forward(unsigned int light_idx) {
  AreaLight l = area_lights[light_idx];
...
void GrahsLTC::draw_basic_scene(const std::string& current_shader) {
...
GrahsLTC::GrahsLTC(std::string const& resource_path)
 :Application{resource_path + "grahs_ltc/"}
 ,quad{}
...
void GrahsLTC::initializeShaderPrograms() {
...
void GrahsLTC::initializeObjects() {
  // init objects
...
int main(int argc, char* argv[]) {
  Launcher::run<GrahsLTC>(argc, argv);
}
